...
export default function Footer() {
	...
	return (
		...
		>
			<div className="flex items-center sm:mx-auto max-w-full justify-around">
				<div>
					<div className="text-center py-1 flex items-center">
				...
				<div>
					<p className="text-sm font-semibold leading-5 text-neutral-800 w-5/6">Follow our store to find out about news and updates on our social networks</p>
